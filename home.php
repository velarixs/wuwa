...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         ?>
         <p> welcome <span><?= $fetch_profile['first_name']; ?></span></p>
      ...
      <div class="box">
         ...
         <div class="flex-box">
         <?php
            $select_authors = $conn->prepare("SELECT DISTINCT name FROM `user` LIMIT 10");
            $select_authors->execute();
            if($select_authors->rowCount() > 0){
               while($fetch_authors = $select_authors->fetch(PDO::FETCH_ASSOC)){ 
         ?>
            <a href="author_posts.php?author=<?= $fetch_authors['first_name']; ?>" class="links"><?= $fetch_authors['first_name']; ?></a>
            <?php
            }
         }else{
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <div class="post-user">
            ...
            <div>
               <a href="author_posts.php?author=<?= $fetch_posts['first_name']; ?>"><?= $fetch_posts['first_name']; ?></a>
         ...
         <a href="view_posts.php?post_id=<?= $post_id; ?>" class="inline-btn">read more</a>
         <a href="category.php?category=<?= $fetch_posts['category']; ?>" class="post-cat"> <i class="fas fa-tag"></i> <span><?= $fetch_posts['category']; ?></span></a>
         <div class="icons">
            <a href="view_posts.php?post_id=<?= $post_id; ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_comments; ?>)</span></a>
